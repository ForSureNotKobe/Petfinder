...
namespace Petfinder.Controllers
{
    public class VetsController : Controller
    {
        ...
        public VetsController(PetfinderContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("VetId,Name,Password,Email,PhoneNumber")] Vet vet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VetId,Name,Password,Email,PhoneNumber")] Vet vet)
        {
            if (id != vet.VetId)
            {
                return NotFound();
